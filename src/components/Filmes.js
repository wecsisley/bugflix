...
const { width: screenWiddth, height: screenHeight } = Dimensions.get('window');
        ...
        return(
            <View>
                <TouchableOpacity>
                    ...
                    style={styles.carouselIcon} onPress={() => alert('Clicou !')}/>
                </TouchableOpacity>
            </View>
        )
    };
            ...
            <View style={{ flex: 1, height: screenHeight }}>
                <View style={{ ...StyleSheet.absoluteFill, backgroundColor: '#000' }}>
                    ...
                    >
                        ...
                        <Text
                            style={{
                                color: '#fff', fontSize: 25, fontHHeight: 'bold',
